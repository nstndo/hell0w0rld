      ...
      <div className="docs-section">
        ...
        <div className="contracts-table">
          ...
          <div className="contract-row">
            <div className="contract-network">
              <div className="network-badge">
                <img src="/images/networks/HAUST.svg" alt="Haust Network" className="badge-logo" />
              </div>
              <div>
                <h3>Haust Network</h3>
                <p className="chain-id">Chain ID: 3864</p>
              </div>
            </div>
            <div className="contract-address-block">
              <a 
                href="https://haustscan.com/address/0xd0c205e3C704595113FB8006379EDd1Bc89B2A17" 
                target="_blank" 
                rel="noopener noreferrer"
                className="address-link"
              >
                HAUST_NETWORK_CONTRACT
                <span className="external-icon">↗</span>
              </a>
            </div>
          </div>
      ...
      <div className="docs-section"></div>
        ...
        <div className="contracts-table">
          ...
          <div className="contract-row">
            <div className="contract-network">
              <div className="network-badge sepolia">
                <img src="/images/networks/OPN.svg" alt="IOPn Testnet" className="badge-logo" />
              </div>
              <div>
                <h3>IOPn Testnet</h3>
                <p className="chain-id">Chain ID: 984</p>
              </div>
            </div>
            <div className="contract-address-block">
              <a 
                href="https://testnet.iopn.tech/address/0xD71caE47F4B4C800E82d9613BCe0f1E40Ae4932e" 
                target="_blank" 
                rel="noopener noreferrer"
                className="address-link"
              >
                IOPN_TESTNET_CONTRACT
                <span className="external-icon">↗</span>
              </a>
            </div>
          </div>
